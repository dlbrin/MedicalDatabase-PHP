...
<html>
	...
	<body>
		<?php
		$sick_name = sec($_GET['sick_name']);
		$query = mysqli_query($db , "SELECT * FROM `sick` WHERE `id` = '$sick_name'");
		...
		<div class="view-doctor-header">
			...
			<form action="modal/sick.inc.php" method="POST">
				...
				<div class="view-doctor-middle">
					...
					<a href="signature_print.php?sick_name=<?php echo sec($row['sick_name']);?>">Print</a>
					<?php } ?>
				</div>
			</form>
		</div>
